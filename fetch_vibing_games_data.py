...
def update_vibing_games_json():
    """Update vibinggames.json with Backloggd links and cover images"""

    # Read the JSON file
    with open('data/vibinggames.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    ...
    print(f"Processing {total} vibing games...\n")
    ...
    with open('data/vibinggames.json', 'w', encoding='utf-8') as f:
